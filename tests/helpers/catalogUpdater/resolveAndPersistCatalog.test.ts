...
const db = {
    ...
    tmdbMetadata: {
        findMany: mock(
            async (params: { where: { tmdbId: { in: number[] } } }) =>
...
mock.module("../../../src/helpers/fileStorage/ensureMinioFolder", () => ({
    ensureMinioFolder: mock(async () => undefined),
}));
mock.module("../../../src/helpers/tmdb/TmdbMovieMatcher", () => ({
...
mock.module("../../../src/helpers/tmdb/fetchTmdbMovieDetails", () => ({
...
mock.module("../../../src/helpers/fileStorage/upsertTmdbMetadata", () => ({
    upsertTmdbMetadata: mock(async () => undefined),
}));
mock.module("../../../src/helpers/fileStorage/uploadTmdbPosterToMinio", () => ({
...
describe("resolveAndPersistCatalog", () => {
    ...
    test("persists a newly fetched title when it was not already in the movie table", async () => {
        const { resolveAndPersistCatalog } =
            await import("../../../src/helpers/catalogUpdater/resolveAndPersistCatalog");
