...
import { evaluateMovieTitleAgainstTmdb } from "@waslaeuftin/scripts/update-movies/syncTmdbMovieCovers";

const TARGET_CINEMAS = ["Filmpalast am ZKM", "Kinemathek Karlsruhe"] as const;
