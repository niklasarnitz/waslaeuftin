          ...
          <div className="flex relative items-center border-b px-3">
            ...
            {query.length > 0 && (
              <button
                ...
                className="text-muted-foreground/60 hover:text-muted-foreground focus-visible:ring-ring absolute right-3 inline-flex h-5 w-5 items-center justify-center rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:outline-none"
