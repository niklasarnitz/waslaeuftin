export default function Legal() {
  return (
    <div className="flex flex-col items-center justify-center space-y-4 p-4">
      ...
      <div className="border-border/70 bg-muted/40 text-muted-foreground max-w-3xl rounded-xl border px-4 py-3 text-center text-sm">
      ...
      <div className="text-center">
        ...
        Rahmen der Erbringung unserer Leistungen als auch insbesondere dieser
        Website.
        <br />
        <br />
        ...
        Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f)
        DSGVO); Website: https://www.hetzner.com; Datenschutzerklärung:
        https://www.hetzner.com/de/rechtliches/datenschutz.
        Auftragsverarbeitungsvertrag:
        https://docs.hetzner.com/de/general/general-terms-and-conditions/data-privacy-faq/.
        <br />
        <br />
        Diese Website nutzt eine selbst gehostete Umami Installation zur
        Datenanalyse.
        <br />
        <br />
        Umami ist eine open source, auf Datenschutz ausgerichtete Alternative zu
        Google Analytics.
        <br />
        <br />
        So können die zur Analyse benötigten Daten erfasst und gleichzeitig die
        Privatspäre der Nutzer:innen respektiert werden.
        <br />
        <br />
        Umami verwendet keine Cookies im Tracking-Code und ist mit der
        Datenschutz-Grundverordnung (DSGVO) konform.
        <br />
        <br />
        Umami sammelt keine persönlich identifizierbaren Informationen und
        anonymisiert alle gesammelten Daten. So können die Nutzer:innen nicht
        identifiziert werden und werden nicht über verschiedene Websites hinweg
        verfolgt.
        <br />
        <br />
        Verarbeitete Datenarten: Nutzungsdaten (z. B. besuchte Webseiten,
        ...
        Mit Hilfe der Reichweitenanalyse können Betreiber von Onlineangeboten z.
        B. erkennen, zu welcher Zeit Nutzer ihre Webseiten besuchen und für
        welche Inhalte sie sich interessieren. Dadurch können sie z. B. die
        Inhalte der Webseiten besser an die Bedürfnisse ihrer Besucher anpassen.
      ...
      <h1 className="text-2xl font-semibold">Zusatzinformation Links</h1>
      <div className="text-center">
        waslaeuft.in stellt Links zu Webseiten anderer Unternehmen zur
        Verfügung, um den Besuchern bestimmte Informationen zur Verfügung zu
        stellen. Ein Link stellt keine Billigung von Inhalten, Standpunkten,
        Richtlinien, Produkten oder Dienstleistungen dieser Website dar. Sobald
        Sie auf eine andere Website verweisen, die nicht von waslaeuft.in
        betrieben wird, unterliegen Sie den Bedingungen dieser Website,
        einschließlich, aber nicht beschränkt auf deren Datenschutzerklärung.
      </div>
      <h1 className="text-2xl font-semibold">
        Zusatzinformation Projekt & Urheberrecht
      </h1>
      <div className="text-center">
        Ich betreibe waslaeuft.in als Open Source Projekt. Das bedeutet, ich
        verdiene kein Geld mit den Daten und entwickle dieses Projekt rein in
        meiner Freizeit und aus meiner Liebe zum Kino.
        <br />
        Daher liegen die Rechte der Daten, die sie auf dieser Website finden
        (z.B. der Name von Filmen, die von Filmen genutzten Technologien, die
        Namen von Kinosälen etc.) bei den jeweiligen Urhebern der jeweiligen
        Filme, Technologien, Kinosälen etc. und nicht bei waslaeuft.in.
        <br />
        waslaeuft.in nutzt nur Daten, die auch einfach durch aufrufen der
        jeweiligen Kinowebsite verfübar sind und bündelt diese nur auf dieser
        Website um eine einfache Übersicht zu haben.
        <br />
        waslaeuft.in übernimmt keinerlei Haftung für die Inhalte der jeweiligen
        Kinowebsites oder für die Verwendung der Daten auf dieser Website.
        <br />
        Falls Sie als Kino-Betreiber nicht wollen, dass waslaeuft.in Daten von
        Ihnen anzeigt, melden Sie sich bitte über die oben genannte E-Mail
        Adresse.
        <br />
        Ansonsten: Vielen Dank für jedes Kino, das regelmäßig Filme zeigt!
      </div>
